    ...
    <div id="tabs" class="section-box">
        <div class="head">
            <ul class="menu-control">
                <li><a class="link-tabs" href="#tabsb-1">Sản phẩm khuyến mãi</a></li>
                <li><a class="link-tabs" href="#tabsb-2">Sản phẩm mới</a></li>
                <li><a class="link-tabs" href="#tabsb-3">Sản phẩm hot</a></li>
            </ul>
            <div class="clr">
            </div>
        </div>
