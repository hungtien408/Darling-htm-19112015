...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="wrapcart-content">
        ...
        <div class="cart-w">
            <table class="tb-wrap tb-infoacc" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                        <th>
                            <h1 class="title-info">
                ...
                <tbody>
                    <tr>
                        <td>
                            <fieldset class="addres-info">
                                ...
                                <div class="info-input">
                                    ...
                                    <div class="info-text">
                                        <asp:TextBox ID="txtPhone1" CssClass="info-textbox" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb">
                                    ...
                                    <div class="info-text">
                                        <asp:TextBox ID="txtEmail1" Enabled="False" CssClass="info-textbox" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb">
                                    ...
                                    <div class="info-text">
                                        <asp:DropDownList ID="ddlProvince1" CssClass="box-select" runat="server">
                                ...
                                <div class="info-input">
                                    <label class="info-lb">
                                        Quận/ Huyện</label>
                                    <div class="info-text">
                                        <asp:DropDownList ID="ddlDistrict1" CssClass="box-select" runat="server">
                                ...
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                        <span class="error-lb">*</span>Địa chỉ giao hàng</label>
                                    <div class="info-text">
                                ...
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                        Ghi chú</label>
                                    <div class="info-text">
                                        <asp:TextBox ID="txtMessage1" CssClass="info-area h70" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                    ...
                                    <div class="info-text">
                                        <div class="info-areatext">
                                            <p>
                                                Cám ơn quý khách đã truy cập vào website PANDEMOS.VN được vận hành bởi SUSTAINABILITY
                                            ...
                                            <p>
                                                PANDEMOS và các nhà cung cấp bên thứ ba, bao gồm Google, có thể sử dụng cookies
                                ...
                                <div class="info-input">
                                    <div class="info-text">
                                        <asp:CheckBox ID="ckbPandemos1" Checked="True" runat="server" Text="Tôi đã đọc, hiểu và đồng ý với các điều khoản của Pandemos"
                            ...
                            <ul class="list-cart">
                                <li id="rbtMoneyShow" runat="server">
                                    ...
                                    <label for="RadioButton1">
                                        <img src="assets/images/icon-cart-1.png" alt="" />Tiền mặt</label>
                                </li>
                                <li>
                                    <asp:RadioButton ID="rbtOnePayNoiDia" runat="server" CssClass="payment paywith-onepaynd"
                                        GroupName="checkradio" />
                                    <label for="RadioButton2">
                                        <img src="assets/images/icon-cart-2.png" alt="" />Thẻ ATM nội địa qua OnePAY</label>
                                </li>
                                <li>
                                    <asp:RadioButton ID="rbtOnePayQuocTe" runat="server" CssClass="payment paywith-onepayqt"
                                        GroupName="checkradio" />
                                    <label for="RadioButton3">
                                        <img src="assets/images/icon-cart-3.png" alt="" />Thẻ VISA, MASTER qua OnePAY</label>
                                </li>
                                <li>
                                    <asp:RadioButton ID="rbtEmail" runat="server" CssClass="payment paywith-email" GroupName="checkradio" />
                                    <label for="RadioButton4">
                                        <img src="assets/images/icon-cart-4.png" alt="" />Thanh toán bằng chuyển khoản trực
                                        tiếp.
                                        <div class="sendemailtext">
                                            &nbsp;&nbsp;&nbsp; &bull; Chi nhánh: Ngân hàng Đông Á - chi nhánh Quận 1<br />
                                            &nbsp;&nbsp;&nbsp; &bull; Số tài khoản: 0909xxxxxx
                                            <br />
                                            &nbsp;&nbsp;&nbsp; &bull; Tên: Nguyễn Văn A
                                        </div>
                                    </label>
                                </li>
                            </ul>
                        ...
                        <td>
                            ...
                            <table class="tb-cart-2" cellpadding="0" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>
                                            <h2 class="name">
            ...
            <div class="btn-button-tk">
                <asp:Button ID="btnOrder" runat="server" ValidationGroup="Information" CssClass="btn-button btn-order"
                    Text="Hoàn thành đơn đặt hàng" />
                <a class="btn-button btn-order" href="gio-hang.aspx">Quay lại giỏ hàng</a>
            </div>
        </div>
    </div>
</asp:Content>
